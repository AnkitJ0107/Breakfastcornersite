...
// let usernameNode = document.getElementById("usrname");
// let passdNode = document.getElementById("passd");
// let errorNode8 = document.getElementById("e1");
...
function validate2() {
    ...
    let regex = new RegExp("^[A-Za-z]*$");
    if (lname === '') {
        errorNode2.innerHTML = "<small>Last name is required</small>";
        lnameNode.style.border = "2px solid red";
        return false;
    }
    else if (regex.test(lname) == false) {
        errorNode2.innerHTML = "<small>Last name must have only letters</small>";
        lnameNode.style.border = "2px solid red";
        return false;
    }
    else {
...
function validate3() {
    ...
    if (mobile === '') {
        errorNode3.innerHTML = "<small>Contact number is required</small>";
...
function validate7() {
    ...
    if (cpass === '') {
        errorNode7.innerHTML = "<small>Confirm Password does not match with password</small>";
...
//     if (usernameNode.value() != "Demo") {
//         errorNode8.innerHTML = "<small>Enter Correct UserName or Password</small>";
//         usernameNode.style.border = "2px solid red";
//         if (passdNode.value() != "Demo@123") {
//             errorNode8.innerHTML = "<small>Enter Correct UserName or Password</small>";
//             passdNode.style.border = "2px solid red";
//             return false;
//         }
//         return false;
//     }
...
//         passdNode.style.border = "2px solid green";
//         return true;
//     }
// }